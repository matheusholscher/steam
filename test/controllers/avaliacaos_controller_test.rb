...
class AvaliacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliacao" do
    assert_difference('Avaliacao.count') do
      post avaliacaos_url, params: { avaliacao: { analise: @avaliacao.analise, estrela: @avaliacao.estrela, jogo_id: @avaliacao.jogo_id, usuario_id: @avaliacao.usuario_id } }
    end
  ...
  test "should update avaliacao" do
    patch avaliacao_url(@avaliacao), params: { avaliacao: { analise: @avaliacao.analise, estrela: @avaliacao.estrela, jogo_id: @avaliacao.jogo_id, usuario_id: @avaliacao.usuario_id } }
